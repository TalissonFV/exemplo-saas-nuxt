import { i as useAuthStore, j as useRouter, e as __nuxt_component_0$1, k as __nuxt_component_4, _ as _export_sfc, f as __nuxt_component_3$1, a as __nuxt_component_0$4, m as mergeConfig, b as useUI, g as defu, c as twJoin, t as twMerge, h as getNuxtLinkProps, d as appConfig } from './server.mjs';
import * as e from 'vue';
import { ref, mergeProps, unref, withCtx, createVNode, createBlock, createCommentVNode, openBlock, toDisplayString, Fragment, renderList, defineComponent, resolveComponent, renderSlot, resolveDynamicComponent, createTextVNode, Transition, toRef, computed, watch, onMounted, onUnmounted, watchEffect, nextTick, provide, inject, cloneVNode, h as h$1, useSSRContext, useId } from 'vue';
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.21.0_change-case@5.4.4_magicast@0.3.5_rollup@4.34.3_typescript@5.7.3_vite@6.1.0_@t_jtn3etlbmqcfj3yvrcugcocwte/node_modules/@nuxt/ui/dist/runtime/components/elements/Kbd.vue");
...
function w$2(e2, r2 = 0) {
  var t2;
  return e2 === ((t2 = i$3(e2)) == null ? undefined : t2.body) ? false : u$3(r2, { [0]() {
...
function I(e2) {
  var r2, t2;
  return (t2 = (r2 = e2 == null ? undefined : e2.matches) == null ? undefined : r2.call(e2, H)) != null ? t2 : false;
}
...
function P(e2, r2, { sorted: t2 = true, relativeTo: l2 = null, skipElements: o2 = [] } = {}) {
  var m;
  let i2 = (m = Array.isArray(e2) ? e2.length > 0 ? e2[0].ownerDocument : undefined : e2 == null ? undefined : e2.ownerDocument) != null ? m : undefined, n2 = Array.isArray(e2) ? t2 ? O$1(e2) : e2 : E(e2);
...
function w(f2, m, l2 = computed(() => true)) {
  ...
  }, true), u$2("touchend", (e2) => a2(e2, () => e2.target instanceof HTMLElement ? e2.target : null), true), w$1("blur", (e2) => a2(e2, () => (undefined).document.activeElement instanceof HTMLIFrameElement ? (undefined).document.activeElement : null), true);
}
function r$1(t2, e2) {
  if (t2) return t2;
...
function y({ props: r2, attrs: t2, slots: e2, slot: o2, name: i2 }) {
  var m, h2;
  let { as: n2, ...l2 } = T(r2, ["unmount", "static"]), a2 = (m = e2.default) == null ? undefined : m.call(e2, o2), d2 = {};
  if (o2) {
    let u2 = false, c2 = [];
...
let ge = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o2, { slots: M, attrs: i$12 }) {
  ...
  return () => {
    ...
    return A$1({ ourProps: { id: p$1, ref: r2, role: "menuitem", tabIndex: u2 === true ? undefined : -1, "aria-disabled": u2 === true ? true : undefined, onClick: b2, onFocus: l2, onPointerenter: a2, onMouseenter: a2, onPointermove: n2, onMousemove: n2, onPointerleave: s3, onMouseleave: s3 }, theirProps: { ...i2, ...h2 }, slot: C, attrs: i2, slots: M, name: "MenuItem" });
  };
} });
...
function mapToStyles(_ref2) {
  ...
  var _offsets$x = offsets.x, x = _offsets$x === undefined ? 0 : _offsets$x, _offsets$y = offsets.y, y2 = _offsets$y === undefined ? 0 : _offsets$y;
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.21.0_change-case@5.4.4_magicast@0.3.5_rollup@4.34.3_typescript@5.7.3_vite@6.1.0_@t_jtn3etlbmqcfj3yvrcugcocwte/node_modules/@nuxt/ui/dist/runtime/components/elements/Dropdown.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gray-50 dark:bg-gray-900" }, _attrs))}><aside class="${ssrRenderClass([unref(isSidebarOpen) ? "w-64" : "w-20", "fixed top-0 left-0 h-full bg-white dark:bg-gray-800 shadow-lg transition-all duration-300 z-50"])}"><div class="p-4 flex flex-col h-full"><div class="flex items-center gap-2 mb-8 px-2">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-chart-bar",
        class: "w-8 h-8 text-primary-500 shrink-0"
      }, null, _parent));
      if (unref(isSidebarOpen)) {
        _push(`<span class="text-xl font-bold truncate">SaaSify</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><nav class="flex-1 space-y-1"><!--[-->`);
      ssrRenderList(menuItems, (item) => {
        _push(ssrRenderComponent(_component_UButton, {
          key: item.label,
          variant: "ghost",
          color: "gray",
          class: ["w-full justify-start", { "!bg-primary-50 dark:!bg-gray-700": item.active }]
        }, {
          default: withCtx((_2, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                ...
                unref(isSidebarOpen) ? (openBlock(), createBlock("span", {
                  key: 0,
                  class: "truncate"
      ...
      _push(`<!--]--></nav><div class="pt-4 border-t border-gray-200 dark:border-gray-700">`);
      _push(ssrRenderComponent(_component_UButton, {
        variant: "ghost",
        color: "gray",
        ...
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UIcon, {
              name: unref(isSidebarOpen) ? "i-heroicons-chevron-left" : "i-heroicons-chevron-right",
              class: "w-5 h-5 shrink-0"
            }, null, _parent2, _scopeId));
            if (unref(isSidebarOpen)) {
              _push2(`<span class="ml-3"${_scopeId}>Collapse</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`</div></div></aside><main class="${ssrRenderClass([[unref(isSidebarOpen) ? "ml-64" : "ml-20"], "transition-all duration-300"])}"><header class="bg-white dark:bg-gray-800 shadow-sm"><div class="flex items-center justify-between px-6 py-4"><div class="flex items-center gap-4">`);
      _push(ssrRenderComponent(_component_UButton, {
        variant: "ghost",
        color: "gray",
        class: "md:hidden",
      ...
      _push(`<h1 class="text-xl font-semibold">Dashboard</h1></div><div class="flex items-center gap-4">`);
      _push(ssrRenderComponent(_component_UButton, {
        variant: "ghost",
        color: "gray",
      ...
      _push(`</div></div></header><div class="p-6"><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6"><!--[-->`);
      ssrRenderList(stats, (stat) => {
        _push(ssrRenderComponent(_component_UCard, {
          ...
          default: withCtx((_2, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><p class="text-sm text-gray-500 dark:text-gray-400"${_scopeId}>${ssrInterpolate(stat.title)}</p><p class="text-2xl font-bold mt-1"${_scopeId}>${ssrInterpolate(stat.value)}</p></div>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: stat.icon,
              ...
              return [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("p", { class: "text-sm text-gray-500 dark:text-gray-400" }, toDisplayString(stat.title), 1),
                    createVNode("p", { class: "text-2xl font-bold mt-1" }, toDisplayString(stat.value), 1)
                  ]),
                  createVNode(_component_UIcon, {
                    name: stat.icon,
                    class: "w-12 h-12 text-primary-500 opacity-20"
      ...
      _push(ssrRenderComponent(_component_UCard, { class: "mb-6" }, {
        header: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-between"${_scopeId}><h3 class="text-lg font-semibold"${_scopeId}>Performance Overview</h3>`);
            ...
            return [
              createVNode("div", { class: "flex items-center justify-between" }, [
                createVNode("h3", { class: "text-lg font-semibold" }, "Performance Overview"),
        ...
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="h-64 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center"${_scopeId}><span class="text-gray-500 dark:text-gray-400"${_scopeId}>Chart Placeholder</span></div>`);
          } else {
            return [
              createVNode("div", { class: "h-64 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center" }, [
                createVNode("span", { class: "text-gray-500 dark:text-gray-400" }, "Chart Placeholder")
              ])
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(_component_UCard, null, {
        header: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 class="text-lg font-semibold"${_scopeId}>Recent Activity</h3>`);
          } else {
            return [
              createVNode("h3", { class: "text-lg font-semibold" }, "Recent Activity")
            ];
          }
        }),
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<ul class="space-y-4"${_scopeId}><!--[-->`);
            ssrRenderList(recentActivities, (activity) => {
              _push2(`<li class="flex items-center gap-4"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: activity.icon,
                class: "w-8 h-8 p-2 rounded-full bg-primary-100 dark:bg-gray-700 text-primary-500"
              }, null, _parent2, _scopeId));
              _push2(`<div${_scopeId}><p class="font-medium"${_scopeId}>${ssrInterpolate(activity.title)}</p><p class="text-sm text-gray-500 dark:text-gray-400"${_scopeId}>${ssrInterpolate(activity.description)}</p></div><span class="ml-auto text-sm text-gray-500 dark:text-gray-400"${_scopeId}>${ssrInterpolate(activity.time)}</span></li>`);
            });
            _push2(`<!--]--></ul>`);
          } else {
            return [
              createVNode("ul", { class: "space-y-4" }, [
                (openBlock(), createBlock(Fragment, null, renderList(recentActivities, (activity) => {
                  return createVNode("li", {
                    ...
                    createVNode("div", null, [
                      createVNode("p", { class: "font-medium" }, toDisplayString(activity.title), 1),
                      createVNode("p", { class: "text-sm text-gray-500 dark:text-gray-400" }, toDisplayString(activity.description), 1)
                    ]),
                    createVNode("span", { class: "ml-auto text-sm text-gray-500 dark:text-gray-400" }, toDisplayString(activity.time), 1)
                  ]);
                }), 64))
              ])
            ];
